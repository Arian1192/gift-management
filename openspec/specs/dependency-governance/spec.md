...
Provides observability of the npm Dependabot update cycle so maintainers can verify, end to end, that outdated dependencies on `dev` are detected and proposed as update pull requests without changing production.
